...
MCP server for automating Naukri.com (India's largest job portal). 61 tools across search, apply, profile management, tracking, and analytics -- hybrid Playwright browser + REST API architecture.
